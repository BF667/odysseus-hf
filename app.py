...
# ========= HF BUCKET STORAGE =========
from src.hf_bucket_storage import get_hf_bucket_storage

hf_bucket_storage = get_hf_bucket_storage()
app.state.hf_bucket_storage = hf_bucket_storage
logger.info("HF Bucket storage initialized")
...
# HF Storage Buckets (cloud storage via Hugging Face)
